  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:#000;fontSize:28px;">海滨体育馆管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.nianjibanji" class="input" type="text" placeholder="年级班级">
			   </div>
			 </div> -->
			<el-form-item label="年级班级" class="input" v-if="tableName=='xuesheng'">
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210206/39a48bc7edda4d29b6b6aa5a1e5de3e2.jpg");
		height: 100vh;
