<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="离开体育馆时间" prop="likaitiyuguanshijian">
          <el-input v-model="ruleForm.likaitiyuguanshijian" 
              placeholder="离开体育馆时间" clearable  :readonly="ro.likaitiyuguanshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="离开体育馆时间" prop="likaitiyuguanshijian">
              <el-input v-model="ruleForm.likaitiyuguanshijian" 
                placeholder="离开体育馆时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='likaitiyuguanshijian'){
            this.ruleForm.likaitiyuguanshijian = obj[o];
	    this.ro.likaitiyuguanshijian = true;
            continue;
          }
          if(o=='tiwen'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `likaidengji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.likaidengjiCrossAddOrUpdateFlag = false;
                  this.parent.search();
