<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="预约部门" prop="yuyuebumen">
          <el-input v-model="ruleForm.yuyuebumen" 
              placeholder="预约部门" clearable  :readonly="ro.yuyuebumen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="预约部门" prop="yuyuebumen">
              <el-input v-model="ruleForm.yuyuebumen" 
                placeholder="预约部门" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="预约场地" prop="yuyuechangdi">
          <el-input v-model="ruleForm.yuyuechangdi" 
              placeholder="预约场地" clearable  :readonly="ro.yuyuechangdi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="预约场地" prop="yuyuechangdi">
              <el-input v-model="ruleForm.yuyuechangdi" 
                placeholder="预约场地" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="预约时间段" prop="yuyueshijianduan">
          <el-input v-model="ruleForm.yuyueshijianduan" 
              placeholder="预约时间段" clearable  :readonly="ro.yuyueshijianduan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="预约时间段" prop="yuyueshijianduan">
              <el-input v-model="ruleForm.yuyueshijianduan" 
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="预约详情" prop="yuyuexiangqing">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="预约详情"
                  v-model="ruleForm.yuyuexiangqing" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yuyuexiangqing" label="预约详情" prop="yuyuexiangqing">
                    <span>{{ruleForm.yuyuexiangqing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='yuyuebumen'){
            this.ruleForm.yuyuebumen = obj[o];
	    this.ro.yuyuebumen = true;
            continue;
          }
          if(o=='yuyuechangdi'){
            this.ruleForm.yuyuechangdi = obj[o];
	    this.ro.yuyuechangdi = true;
            continue;
          }
          if(o=='huodongneirong'){
	    ...
	    this.ro.yuyuexiangqing = true;
          ...
          if(o=='yuyueshijianduan'){
            this.ruleForm.yuyueshijianduan = obj[o];
	    this.ro.yuyueshijianduan = true;
            continue;
          }
          if(o=='xuehao'){
